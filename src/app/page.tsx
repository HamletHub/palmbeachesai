          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-destructive/20 hover:border-destructive/40 transition-colors">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-bold text-primary mb-4">Lack of Strategic Alignment</h3>
                <p className="text-muted-foreground leading-relaxed">
                  AI initiatives launched without clear business objectives or measurable outcomes, 
                  leading to solutions that don&apos;t address real problems.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-destructive/20 hover:border-destructive/40 transition-colors">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-bold text-primary mb-4">Poor Data Foundation</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Insufficient, low-quality, or improperly prepared data that makes 
                  AI models unreliable and business insights meaningless.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-destructive/20 hover:border-destructive/40 transition-colors">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-bold text-primary mb-4">Implementation Gaps</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Failure to integrate AI solutions into existing workflows and 
                  lack of change management for successful adoption.
                </p>
              </CardContent>
            </Card>
          </div>
